...
<head>
    ...
    <link rel="stylesheet" href="./css/pixijs1.css">
...
<body>
    <script type="text/javascript">
      ...
      var app = new PIXI.Application(window.innerWidth, window.innerHeight);
       ...
       PIXI.loader.add("images/levizja.png").add("images/goja.jpg").load(setup);


      function setup() {
            posX = app.renderer.width / 2;
            displacementSprite = new PIXI.Sprite(PIXI.loader.resources["images/levizja.png"].texture);
            ...
            bg = new PIXI.Sprite(PIXI.loader.resources["images/goja.jpg"].texture);
